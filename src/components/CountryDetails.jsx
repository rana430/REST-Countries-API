...
export const CountryDetails=({countries,showDetails,refetch})=>{
    ...
    : [];
      const currencyValues = Object.values(country.currencies || {}).map(currency => currency.name);
      const languageValues = Object.values(country.languages || {}).map(language => language);
      console.log(country);
